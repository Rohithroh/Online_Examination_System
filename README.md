...
4. Open Your browser put inside "http://localhost/Online_examination_System/" 

5. To Login as admin put "http://localhost/Online_examination-System/admin" Admin Login Details Login Id: admin@a
